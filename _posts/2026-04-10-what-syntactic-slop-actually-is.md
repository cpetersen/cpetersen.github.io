...
If the model has written "it was a dark and stormy" its top guess for the next word is "night" and almost nothing else. A small number of words account for nearly all the probability.
